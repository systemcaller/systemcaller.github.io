...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/yuanshen1.webp)" class="imgbox" onclick="changeBg('url(/assets/background/yuanshen1.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/dm2.webp)" class="imgbox" onclick="changeBg('url(/assets/background/dm2.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/dm8.webp)" class="imgbox" onclick="changeBg('url(/assets/background/dm8.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/dm11.webp)" class="imgbox" onclick="changeBg('url(/assets/background/dm11.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/dm15.webp)" class="imgbox" onclick="changeBg('url(/assets/background/dm15.webp)')"></a>
</div>
{% endfolding %}
...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/mb4.webp)" class="pimgbox" onclick="changeBg('url(/assets/background/mb4.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/mb7.webp)" class="pimgbox" onclick="changeBg('url(/assets/background/mb7.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/mb16.webp)" class="pimgbox" onclick="changeBg('url(/assets/background/mb16.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/assets/background/mb19.webp)" class="pimgbox" onclick="changeBg('url(/assets/background/mb19.webp)')"></a>
</div>
{% endfolding %}
